...
class Bottleneck(nn.Module):
    ...
    def forward(self, x):   # torch.Size([1, 64, 64, 64])
        ...
        out = self.conv1(x)     # torch.Size([1, 64, 64, 64])
        out = self.bn1(out)     # torch.Size([1, 64, 64, 64])
        out = self.relu(out)    # torch.Size([1, 64, 64, 64])

        out = self.conv2(out)   # torch.Size([1, 64, 64, 64])
        out = self.bn2(out)     # torch.Size([1, 64, 64, 64])
        out = self.relu(out)    # torch.Size([1, 64, 64, 64])

        out = self.conv3(out)   # torch.Size([1, 256, 64, 64])
        out = self.bn3(out)     # torch.Size([1, 256, 64, 64])

        if self.downsample is not None:
            residual = self.downsample(x)       # torch.Size([1, 256, 64, 64])

        out += residual     # torch.Size([1, 256, 64, 64])
        out = self.relu(out)    # torch.Size([1, 256, 64, 64])
...
class ResNet(Backbone):
    ...
    def __init__(self, block, layers, output_layers, num_classes=1000, inplanes=64, dilation_factor=1, frozen_layers=()):       # lpp
    ...
    def forward(self, x, output_layers=None):   # x.shape:torch.Size([1, 3, 256, 256])
        ...
        x = self.bn1(x)     # torch.Size([1, 64, 128, 128])
        x = self.relu(x)        # torch.Size([1, 64, 128, 128])

        if self._add_output_and_check('conv1', x, outputs, output_layers):
            return outputs

        x = self.maxpool(x)     # torch.Size([1, 64, 64, 64])
