...
class PositionEmbeddingSine(nn.Module):
    ...
    def forward(self, tensor_list: NestedTensor):
        ...
        # dim_t = self.temperature ** (2 * (dim_t // 2) / self.num_pos_feats)     # torch < 1.12
        dim_t = self.temperature ** (2 * torch.div(dim_t, 2,rounding_mode='trunc') / self.num_pos_feats)     # torch = 1.12
