def build_backbone(config: dict, load_pretrained=True):
    ...
    if backbone_config['type'] == 'swin_transformer':
        from ltr.models_.backbone.swin_transformer import build_swin_transformer_backbone
        ...
        from ltr.models_.backbone.resnet50_mod_layer_3_dilation_2 import resnet50
