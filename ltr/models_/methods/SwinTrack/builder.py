# from core.run.event_dispatcher.register import EventRegister#注释
...
from ltr.models_.backbone.builder import build_backbone
from ltr.models_.head.builder import build_head
from .network import SwinTrack
# from data.tracking.methods.SiamFC.pseudo_data import build_siamfc_pseudo_data_generator#注释
