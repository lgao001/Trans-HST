...
def build_concatenated_fusion_encoder(config, drop_path_allocator,
    ...
    if untied_position_embedding_config['relative']['enabled']:
        from ....positional_encoding.untied.relative import RelativePosition2DEncoder, generate_2d_concatenated_self_attention_relative_positional_encoding_index,generate_2d_concatenated_self_attention_relative_positional_encoding_index_1
        # clk
        ...
        # rpe_index = generate_2d_concatenated_self_attention_relative_positional_encoding_index_1((z_shape[1], z_shape[0]), (x_shape[1], x_shape[0]))
