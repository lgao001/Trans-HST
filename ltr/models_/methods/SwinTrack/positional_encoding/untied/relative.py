...
def generate_2d_concatenated_self_attention_relative_positional_encoding_index_1(z_shape, x_shape):
    '''
        z_shape: (z_h, z_w)
        x_shape: (x_h, x_w)
    '''
    ...
    # concatenated_2d_index_h = torch.cat((x_2d_index_h))
    # concatenated_2d_index_w = torch.cat((x_2d_index_w))

    concatenated_2d_index_h = x_2d_index_h
    concatenated_2d_index_w = x_2d_index_w
...
# def generate_2d_concatenated_cross_attention_relative_positional_encoding_index_1(z_shape, x_shape):
#     '''
#         z_shape: (z_h, z_w)
#         x_shape: (x_h, x_w)
#     '''
