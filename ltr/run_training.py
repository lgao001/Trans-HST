...
def run_training(train_module, train_name, cudnn_benchmark=True):
    ...
    settings.project_path = 'ltr/{}/{}'.format(train_module, train_name)            # 'ltr/transt/transt'
...
def main():
    ...
    parser.add_argument('--train_name', type=str, default='transt', help='Name of the train settings file.')
