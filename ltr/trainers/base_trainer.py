...
class BaseTrainer:
    ...
    def update_settings(self, settings=None):
        ...
        if self.settings.env.workspace_dir is not None:
            ...
            self._checkpoint_dir = os.path.join(self.settings.env.workspace_dir, 'checkpoints')         # '/home/data/liupan/tracking/TransT-main/pytracking/networks/checkpoints'
    ...
    def save_checkpoint(self):
        ...
        file_path = '{}/TransT-SwinT_ep{:04d}.pth'.format(directory, self.epoch)
    ...
    def load_checkpoint(self, checkpoint = None, fields = None, ignore_fields = None, load_constructor = False):
        ...
        if checkpoint is None:
            ...
            #                                                                  self.settings.project_path, net_type)))              # lpp
            checkpoint_list = sorted(glob.glob('{}/{}/{}.pth'.format(self._checkpoint_dir, 'pretrain_weight','transt')))               # lpp
        ...
        # assert net_type == checkpoint_dict['net_type'], 'Network is not of correct type.'         # lpp
